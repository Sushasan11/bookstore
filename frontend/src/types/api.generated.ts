...
export interface paths {
    ...
    "/auth/google/token": {
         ...
         * @description Exchange a Google id_token (from NextAuth) for a FastAPI token pair.
         *
         ...
         */
        post: operations["google_token_exchange_auth_google_token_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        /**
         * GoogleTokenRequest
         * @description POST /auth/google/token request body — Google id_token from NextAuth.
         */
        GoogleTokenRequest: {
            /** Id Token */
            id_token: string;
...
export interface operations {
    ...
    google_token_exchange_auth_google_token_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    list_books_books_get: {
        parameters: {
            query?: {
                ...
                /** @description Sort order: title (A-Z), price, date (publish_date), created_at (newest first), avg_rating (highest rated first) */
                sort?: "title" | "price" | "date" | "created_at" | "avg_rating";
